...
//--------------------------------------------------------------------------------
//Command: generate_target bd_088f.bd
//Design : bd_088f
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_088f,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_088f,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "DEMO_axi_smc_1_3.hwdef" *) 
module bd_088f
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_1FLXXVI m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_FUYBWD s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_CD6QAV s00_nodes
...
module m00_exit_pipeline_imp_1FLXXVI
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_FUYBWD
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_088f_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_088f_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_088f_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
