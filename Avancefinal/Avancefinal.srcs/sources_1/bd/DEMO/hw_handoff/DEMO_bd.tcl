...
proc create_root_design { parentCell } {
  ...
  set LIGHT_IRQ [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LIGHT_IRQ ]
  ...
  set BuzzerBooster_Driver_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:BuzzerBooster_Driver_v1_0:1.0 BuzzerBooster_Driver_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ATG_SYSTEM_INIT_ADDR_MIF {../../../../imports/COE1/addr.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_CTRL_MIF {../../../../imports/COE1/ctrl.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_DATA_MIF {../../../../imports/COE1/data.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_MASK_MIF {../../../../imports/COE1/mask.coe} \
 ] $axi_traffic_gen_0
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports LIGHT_IRQ] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs BuzzerBooster_Driver_0/s00_axi/reg0] -force
